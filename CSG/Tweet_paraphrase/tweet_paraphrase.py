...
from curp.dataset import CSG_tweet, simple_collate_fn
...
def load_model(config, device):
    """Initialize tokenizer and load the trained CSG model."""
...
def inference_from_dataset(config, device):
    ...
    output_path = os.path.join(config["output_dir"], "csg_tweet.json")
...
def main():
    ...
    config = {
        ...
        "val_data_path": "/root/wangliang/Understanding-Generation/curp/CSG/Tweet_paraphrase/val_final.json",
