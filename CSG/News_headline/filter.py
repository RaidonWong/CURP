...
csg_news_file = '/root/wangliang/Understanding-Generation/curp/CSG/csg_news.json'
val_final_file = '/root/wangliang/Understanding-Generation/curp/CSG/News_headline/val_final.json'
output_file = '/root/wangliang/Understanding-Generation/curp/CSG/News_headline/filtered_ans.json'
